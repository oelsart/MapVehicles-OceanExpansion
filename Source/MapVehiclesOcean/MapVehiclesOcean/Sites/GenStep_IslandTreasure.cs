  ...
  public override void Generate(Map map, GenStepParams parms)
  {
    ...
    if (quest is not null)
    {
      Predicate<IntVec3> validator = c =>
        c.Roofed(map) && GenSpawn.CanSpawnAt(MVO_DefOf.MVO_Stele, c, map, Rot4.North, false);
    ...
    Predicate<IntVec3> validator2 =
      c => c.Roofed(map) && GenSpawn.CanSpawnAt(MVO_DefOf.MVO_StoneCoffer, c, map, rot, false);
    ...
    {
      var coffer = (Building_Crate)ThingMaker.MakeThing(MVO_DefOf.MVO_StoneCoffer,
        GenStuff.RandomStuffFor(MVO_DefOf.MVO_StoneCoffer));
