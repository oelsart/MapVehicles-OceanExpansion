...
public class MeshSettings : IExposable
{
  ...
  public static void Init()
  {
    ...
    {
      Log.Warning(
        $"[NANAME Walls] Caught exception while loading default settings data. Generating fresh settings. The exception was: {ex}");
    }
  ...
  public void ExposeData()
  {
    ...
    switch (Scribe.mode)
    {
      case LoadSaveMode.LoadingVars:
      {
        ...
        if (curDefault != null)
        {
          foreach (var defaultItem in curDefault.settingItems.Values.Where(i =>
                     !settingItems.ContainsKey(i.label) && !ignoreList.Contains(i.label)))
          {
